      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        (function(global, factory) {
          ...
          var Zone$1 = (function(global) {
            ...
            var Zone = /** @class */ (function() {
              ...
              Zone.prototype.wrap = function(callback, source) {
                ...
                var _callback = this._zoneDelegate.intercept(
                  this,
                  callback,
                  source
                );
              ...
              Zone.prototype.runGuarded = function(
                callback,
                applyThis,
                applyArgs,
                source
            ...
            var ZoneDelegate = /** @class */ (function() {
              function ZoneDelegate(zone, parentDelegate, zoneSpec) {
                ...
                this._interceptCurrZone =
                  zoneSpec &&
                  (zoneSpec.onIntercept ? this.zone : parentDelegate.zone);
                this._invokeZS =
                  zoneSpec &&
                ...
                this._invokeCurrZone =
                  zoneSpec &&
                  (zoneSpec.onInvoke ? this.zone : parentDelegate.zone);
                this._handleErrorZS =
                  zoneSpec &&
                ...
                this._handleErrorCurrZone =
                  zoneSpec &&
                  (zoneSpec.onHandleError ? this.zone : parentDelegate.zone);
                ...
                this._scheduleTaskCurrZone =
                  zoneSpec &&
                  (zoneSpec.onScheduleTask ? this.zone : parentDelegate.zone);
                this._invokeTaskZS =
                  zoneSpec &&
                ...
                this._invokeTaskCurrZone =
                  zoneSpec &&
                  (zoneSpec.onInvokeTask ? this.zone : parentDelegate.zone);
                this._cancelTaskZS =
                  zoneSpec &&
                ...
                this._cancelTaskCurrZone =
                  zoneSpec &&
                  (zoneSpec.onCancelTask ? this.zone : parentDelegate.zone);
              ...
              ZoneDelegate.prototype.intercept = function(
                targetZone,
                callback,
                source
              ) {
              ...
              ZoneDelegate.prototype.invoke = function(
                targetZone,
                callback,
                applyThis,
                applyArgs,
              ...
              ZoneDelegate.prototype.invokeTask = function(
                targetZone,
                task,
                applyThis,
                applyArgs
            ...
            var ZoneTask = /** @class */ (function() {
              ...
              ZoneTask.prototype._transitionTo = function(
                toState,
                fromState1,
                fromState2
              ) {
          ...
          Zone.__load_patch('ZoneAwarePromise', function(global, Zone, api) {
            ...
            var UNHANDLED_PROMISE_REJECTION_HANDLER_SYMBOL = __symbol__(
            ...
            var REJECTION_HANDLED_HANDLER = __symbol__(
            ...
            var ZONE_AWARE_PROMISE_TO_STRING =
            ...
            var ZoneAwarePromise = /** @class */ (function() {
              ...
              ZoneAwarePromise.prototype.then = function(
                onFulfilled,
                onRejected
              ) {
          ...
          var ZONE_SYMBOL_ADD_EVENT_LISTENER = Zone.__symbol__(
            ADD_EVENT_LISTENER_STR
          );
          /** zoneSymbol removeEventListener */
          var ZONE_SYMBOL_REMOVE_EVENT_LISTENER = Zone.__symbol__(
          ...
          function patchPrototype(prototype, fnNames) {
            ...
            var _loop_1 = function(i) {
              ...
              if (delegate) {
                var prototypeDesc = ObjectGetOwnPropertyDescriptor(
                  prototype,
                  name_1
                );
                ...
                prototype[name_1] = (function(delegate) {
                  var patched = function() {
                    return delegate.apply(
                      this,
                      bindArguments(arguments, source + '.' + name_1)
                    );
                  };
              ...
              if (typeof this === 'function') {
                ...
                if (originalDelegate) {
                  if (typeof originalDelegate === 'function') {
                    return originalFunctionToString.apply(
                      this[ORIGINAL_DELEGATE_SYMBOL],
                      arguments
                    );
                  } else {
          ...
          var IMMEDIATE_PROPAGATION_SYMBOL =
          ...
          function patchEventTarget(_global, apis, patchOptions) {
            ...
            var PREPEND_EVENT_LISTENER_SOURCE =
            ...
            var invokeTask = function(task, target, event) {
              ...
              if (options && typeof options === 'object' && options.once) {
                ...
                var delegate_1 = task.originalDelegate
            ...
            function patchEventTargetMethods(obj, patchOptions) {
              ...
              var taskData = {};
              var nativeAddEventListener = (proto[zoneSymbolAddEventListener] =
                proto[ADD_EVENT_LISTENER]);
              var nativeRemoveEventListener = (proto[
                zoneSymbol(REMOVE_EVENT_LISTENER)
              ] =
                proto[REMOVE_EVENT_LISTENER]);
              var nativeListeners = (proto[
              ...
              var customSchedule = useGlobalCallback
                ? customScheduleGlobal
                : customScheduleNonGlobal;
              var customCancel = useGlobalCallback
                ? customCancelGlobal
              ...
              var makeAddListener = function(
                ...
                return function() {
                  ...
                  var task = zone.scheduleEventTask(
                    source,
                    delegate,
                    data,
                    customScheduleFn,
              ...
              proto[LISTENERS_EVENT_LISTENER] = function() {
                ...
                for (var i = 0; i < tasks.length; i++) {
                  var task = tasks[i];
                  var delegate = task.originalDelegate
                    ? task.originalDelegate
                    : task.callback;
 ...
 */
          var _defineProperty = (Object[zoneSymbol('defineProperty')] =
            Object.defineProperty);
          var _getOwnPropertyDescriptor = (Object[
            zoneSymbol('getOwnPropertyDescriptor')
          ] =
            Object.getOwnPropertyDescriptor);
          ...
          function apply(api, _global) {
            ...
            _global.WebSocket = function(x, y) {
              ...
              var onmessageDesc = ObjectGetOwnPropertyDescriptor(
                socket,
                'onmessage'
              );
              if (onmessageDesc && onmessageDesc.configurable === false) {
                ...
                [
                  ...
                  proxySocket[propName] = function() {
                    ...
                    if (
                      propName === ADD_EVENT_LISTENER_STR ||
                      propName === REMOVE_EVENT_LISTENER_STR
                    ) {
                      var eventName = args.length > 0 ? args[0] : undefined;
                      if (eventName) {
                        var propertySymbol = Zone.__symbol__(
                          'ON_PROPERTY' + eventName
                        );
          ...
          function patchFilteredProperties(
            ...
            var filteredProperties = filterProperties(
              target,
              onProperties,
              ignoreProperties
            );
            ...
            if (canPatchViaPropertyDescriptor()) {
              ...
              if (isBrowser) {
                ...
                if (HTMLMarqueeElement_1) {
                  patchFilteredProperties(
                    HTMLMarqueeElement_1.prototype,
                    marqueeEventNames,
                    ignoreProperties
                  );
                }
          ...
          function canPatchViaPropertyDescriptor() {
            if (
              ...
              var desc = ObjectGetOwnPropertyDescriptor(
                Element.prototype,
                'onclick'
              );
            ...
            var xhrDesc = ObjectGetOwnPropertyDescriptor(
          ...
          function eventTargetPatch(_global, api) {
            ...
            var isEnableCrossContextCheck =
              _global['__Zone_enable_cross_context_check'] || false;
            ...
            for (var i = 0; i < WTF_ISSUE_555.length; i++) {
              ...
              for (var j = 0; j < eventNames.length; j++) {
                ...
                targets[eventName] =
                  target + ADD_EVENT_LISTENER_SOURCE + eventName;
              }
            }
            var checkIEAndCrossContext = function(
              nativeDelegate,
              delegate,
              target,
              args
              ...
              if (!isDisableIECheck && ieOrEdge) {
                if (isEnableCrossContextCheck) {
                  try {
                    ...
                    if (
                      testString === FUNCTION_WRAPPER ||
                      testString == BROWSER_TOOLS
                    ) {
          ...
          function registerElementPatch(_global) {
            if (
              (!isBrowser && !isMix) ||
              !('registerElement' in _global.document)
            ) {
              return;
            }
                ...
                callbacks.forEach(function(callback) {
                  ...
                  if (prototype.hasOwnProperty(callback)) {
                    ...
                    if (descriptor && descriptor.value) {
                      descriptor.value = wrapWithCurrentZone(
                        descriptor.value,
                        source
                      );
                      _redefineProperty(opts.prototype, callback, descriptor);
                    } else {
                      prototype[callback] = wrapWithCurrentZone(
                        prototype[callback],
                        source
                      );
                    }
          ...
          Zone.__load_patch('EventTarget', function(global, Zone, api) {
            ...
            var SYMBOL_BLACK_LISTED_EVENTS = Zone.__symbol__(
              'BLACK_LISTED_EVENTS'
            );
            if (global[SYMBOL_BLACK_LISTED_EVENTS]) {
              Zone[SYMBOL_BLACK_LISTED_EVENTS] =
          ...
          Zone.__load_patch('canvas', function(global) {
            ...
            if (
              ...
              patchMacroTask(HTMLCanvasElement.prototype, 'toBlob', function(
                self,
                args
              ) {
                return {
  ...
  \**************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var core_js_es7_reflect__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! core-js/es7/reflect */ './node_modules/core-js/es7/reflect.js'
        );
        /* harmony import */ var core_js_es7_reflect__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(
        ...
        /* harmony import */ var zone_js_dist_zone__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! zone.js/dist/zone */ './node_modules/zone.js/dist/zone.js'
        );
